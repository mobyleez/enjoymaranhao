    ...
    <section className="bg-background py-16 lg:py-[120px] px-5 lg:px-16 relative overflow-hidden">
      <div className="flex flex-col lg:flex-row justify-between lg:items-start mb-10 lg:mb-16 gap-8 reveal">
        ...
        <div className="text-center flex-shrink-0">
          ...
          {/* Rating label - white, not uppercase */}
          <p className="font-playfair font-black tracking-[1px] text-white" style={{ fontSize: 'clamp(20px, 3vw, 36px)' }}>
            {testimonials.ratingLabel}
          </p>
          {/* Rating count */}
          <p className="text-[11px] tracking-[1px] text-[rgba(255,255,255,0.4)] mt-1">
            {testimonials.ratingCount}
          </p>
          {/* Google logo */}
          <svg className="mx-auto mt-3" width="80" height="26" viewBox="0 0 272 92" xmlns="http://www.w3.org/2000/svg">
